...
namespace Warcraft.Core.Shading.MDX
{
    ...
    public static class MDXShaderHelper
    {
        ...
        public static ushort GetRuntimeShaderID(ushort baseShaderID, MDXRenderBatch renderBatch, Warcraft.MDX.MDX model)
        {
            ...
            var material = model.Materials != null ? model.Materials[renderBatch.MaterialIndex] : null;

            ushort newShaderID = 0;

            if (!model.GlobalModelFlags.HasFlag(ModelObjectFlags.HasBlendModeOverrides))
            {
                MDXTextureMappingType textureMapping = 0;
                if (model.TextureMappingLookupTable != null)
                    textureMapping = model.TextureMappingLookupTable[renderBatch.TextureMappingLookupTableIndex];
            ...
            for (var operationIndex = 0; operationIndex < operationCount; ++operationIndex)
            {
                ...
                var blendingOverride = model.BlendMapOverrides != null ? model.BlendMapOverrides[blendingOverrideIndex] : 0;
                ...
                var textureSlotOverride = model.TextureMappingLookupTable != null ? model.TextureMappingLookupTable[textureMappingOverrideIndex] : 0;
